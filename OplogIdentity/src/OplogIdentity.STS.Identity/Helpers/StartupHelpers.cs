...
using SendGrid;
using OplogIdentity.STS.Identity.Configuration;
using OplogIdentity.STS.Identity.Configuration.ApplicationParts;
using OplogIdentity.STS.Identity.Configuration.Constants;
using OplogIdentity.STS.Identity.Configuration.Interfaces;
using OplogIdentity.STS.Identity.Helpers.Localization;
using OplogIdentity.STS.Identity.Services;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using OplogIdentity.Admin.EntityFramework.MySql.Extensions;
using OplogIdentity.Admin.EntityFramework.PostgreSQL.Extensions;
using OplogIdentity.Admin.EntityFramework.Shared.Configuration;
using OplogIdentity.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;

namespace OplogIdentity.STS.Identity.Helpers
{
